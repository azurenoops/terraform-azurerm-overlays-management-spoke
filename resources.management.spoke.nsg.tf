...
resource "azurerm_network_security_group" "nsg" {
  ...
  name                = var.custom_network_security_group_name != null ? "${var.custom_network_security_group_name}_${each.key}" : "${data.azurenoopsutils_resource_name.nsg[each.key].result}"
